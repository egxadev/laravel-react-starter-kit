...
import { DataTableRowActions, useDeleteAction, usePatchAction } from '@/components/data-table-row-actions';
...
const ActionCell = ({ data, isTrashed = false }: { data: User; isTrashed?: boolean }) => {
    ...
    const handleForceDelete = useDeleteAction(forceDeleteUsers({ user: data.id }).url);
    ...
    const activeActions = [
        ...
        },
        {
            ...
            confirm: {
                ...
                description: 'This will move the user to trash. You can restore it later.',
            },
    ...
    const trashedActions = [
        {
            ...
            confirm: {
                title: 'Restore User',
                description: 'This will restore the user and make it available again.',
    ...
    return <DataTableRowActions actions={isTrashed ? trashedActions : activeActions} />;
};
